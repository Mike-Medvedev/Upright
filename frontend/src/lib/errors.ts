...
export const INFERENCE_ERROR_CODES = {
  ...
  MISSING_VIDEO_DIMENSIONS: "MISSING_VIDEO_DIMENSIONS",
  MISSING_KEYPOINTS: "MISSING_KEYPOINTS",
  MISSING_EAR_KEYPOINTS: "MISSING_EAR_KEYPOINTS",
